...
def main(argv):
    ...
    batman = False
    try:
        opts, args = getopt.getopt(argv, "ewsbhfgn:dm", ["ethernet","wifi","silvus","batman","help","name=","disableDisplay","measuring"])
    ...
    ovs = OnboardVehicleSystem("MULTI_ROTOR", name, network_type, display, kill, location_data)
    
    if location_data == "gps":
        ovs.connect_to_gps()
    else:
